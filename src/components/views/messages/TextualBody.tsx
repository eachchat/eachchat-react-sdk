...
// import SchemaTest from '../message_schema';
import SchemaForm from '../message_schema/schema/index';
...
export default class TextualBody extends React.Component<IBodyProps, IState> {
    ...
    constructor(props) {
        super(props);
        // console.log('TextualBody props',props)
        this.state = {
            links: [],
            widgetHidden: false,
        };
    ...
    render() {
        ...
        return (
            <div className="mx_MTextBody mx_EventTile_content  123123" onClick={this.onBodyLinkClick}>
                {/* <SchemaTest /> */}
                {/* <SchemaForm /> */}
                {/* <iframe allow="camera; microphone; fullscreen; display-capture; autoplay" src="https://meet.jit.si/MartialHighlightsOptJealously" style="height: 100%; width: 100%; border: 0px;"></iframe> */}
                {/* <iframe title='测试' src="http://127.0.0.1:5500/test.html" frameBorder="0" /> */}
                {/* <br /> */}
                {/* <iframe title='测试'
                width={"100%"}
                // height={'100%'}
                src="https://meet.jit.si/MartialHighlightsOptJealously" frameBorder="0" /> */}

                {/* <iframe title='测试' src="https://cn.bing.com/" frameBorder="0" /> */}
                {/* <iframe title='测试' src="https://meet.jit.si/MartialHighlightsOptJealously" frameBorder="0" allow="camera; microphone; fullscreen; display-capture; autoplay" style="height: 100%; width: 100%; border: 0px;"/> */}
                {/* <iframe title='测试' src="https://meet.jit.si/MartialHighlightsOptJealously" frameBorder="0" style="height: 100%; width: 100%; border: 0px;"/> */}
